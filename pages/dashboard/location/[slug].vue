...
function openDialog() {
  isOpen.value = true;
  (document.activeElement as HTMLAnchorElement).blur(); // closes the dropdown after click on button
}
...
<template>
  <div class="p-4 min-h-64">
    ...
    <AppDialog
      :is-open="isOpen"
      title="Are you shure?"
      description="Deleting this location will also delete all of the assiciated logs. This cannot be undone. Do you really want to continue?"
